...
function NewCurrency(props) {
  ...
  return (
    <div className="currency-container">
      ...
      {canConvert() ? (
        <p className="uses">
          {props.countryName} uses {currency}.
        </p>
      ) : (
        <p>
          {props.countryName} uses {currency}. We cannot convert to {currency}{" "}
          at this time.
        </p>
      )} */}
      ...
      <div className="currency-converter-row">
        ...
        <div className="currency-converter-col">
          &nbsp;
          <button className="button-swap" onClick={swapCurrencies}>
            Swap
          </button>
        </div>
        ...
        <div className="currency-converter-col">
          ...
          <select
            ...
            <option className="currency-input" value="default">
              Select a Currency
            </option>
            {currencyKeys.map((key) => {
              let currencyObj = currencies[key];
      ...
      <div className="currency-converter-row">
        <button className="button-convert" onClick={getConversionData}>
          Convert
        </button>
      </div>
      ...
      {convertedAmount != "" ? (
        <div className="conversions-container">
          ...
          <div className="conversion-row">
            <p>
              {conversions[0]} {fromCurrency} = {conversions[1]} {toCurrency}
            </p>
          </div>
          <div className="conversion-row">
            <p>
              {" "}
              1 {toCurrency} = {1 / conversions[1]} {fromCurrency}
            </p>
          </div>
        </div>
      ) : null}
