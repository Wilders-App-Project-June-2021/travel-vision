    ...
    <div className="fadeIn">
        ...
        <div className="currencyWrapper">
          <div className="currencyCard">
            ...
            <div className="currencyBottomSection">
              <h1 className="currencyName">{selectedCountry.currencyName}</h1>
              <input
                type="number"
      ...
      <div className="currencyContainerMobile">
        <div className="currencyCard">
          ...
          <div className="currencyBottomSection">
            ...
            <input
              ...
              value={amount}
            />
            <h1 className="currencySymbol">{selectedCountry.currencySymbol}</h1>
          </div>
        </div>
        ...
        <div className="currencyCard">
          ...
          <div className="currencyBottomSection">
            <h1 className="currencyName">{destinationCountry.currencyName}</h1>
            <div className="currencyInputNumber pink">
              {getExchangeValue(destinationCountry.currencyName)}
            </div>
            <h1 className="currencySymbol">
